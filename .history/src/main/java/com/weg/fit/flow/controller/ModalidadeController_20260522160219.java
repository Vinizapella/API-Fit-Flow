...
public class ModalidadeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ModalidadeResponseDTO> atualizarModalidadePorId(
        @RequestBody
        ...
        return ResponseEntity.status(HttpStatus.OK)
        .body(modalidadeService.atualizarModalidade(modalidadeUpdateDTO, id));
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<ModalidadeResponseDTO> deletarModalidadePorId(
        @PathVariable
        Long id
    ){
        return ResponseEntity.status(HttpStatus.OK)
        .body(modalidadeService.deletarModalidade(id)));
    }
